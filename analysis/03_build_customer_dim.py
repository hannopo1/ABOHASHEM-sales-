...
# The CURRENT AR snapshot, generated by analysis/00_ar_snapshot.py from the
# balance reports named in executive_dashboard/src/config.py. Pointing at a
# dated filename here is what let this step sit two months behind the app.
AR_CSV = ROOT / "data" / "processed" / "ar_customer_balances_current.csv"
